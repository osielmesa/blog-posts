...
seoTitle: "One Prompt, One Design, One App: Claude Code + Figma MCP"
seoDescription: "Learn how to connect Claude Code to Figma using the Model Context Protocol (MCP). Two setup paths covered: the official Figma plugin and the open-source alternative."
tags: ["React Native", "React", "Claude", "Figma", "MCP", "AI", "Developer Tools"]
series: "Guides"
---
